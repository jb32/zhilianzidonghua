...
var _RecordViewController = __webpack_require__(110);

var _RecordViewController2 = _interopRequireDefault(_RecordViewController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_RecordViewController2.default.el = '#root';
new Vue(_RecordViewController2.default);
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/src/RecordViewController.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3a62d14b"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _wxcTabPage = __webpack_require__(119);
...
var _RecordVM = __webpack_require__(125);
...
exports.default = {
  ...
  components: { FlexWap: _FlexWap2.default, UILine: _UILine2.default, NavBar: _NavBar2.default, WxcTabPage: _wxcTabPage2.default, WxcSearchbar: _wxcSearchbar2.default },
  data: function data() {
    return {
      sheds: {},
      baketimeNames: ['零', '一', '二', '三', '四', '五', '六', '七', '八', '九'],
      is_loading: false,
      recordVM: new _RecordVM.RecordVM(),
  ...
  methods: {
    onviewdisappear: function onviewdisappear() {
      _Request.request.interrupt(_Order.SubOrder.record, _Order.RW.read);
    },
    toPage: function toPage(e) {
      this.recordVM.getRecord(e.page);
    },
    to_loading: function to_loading(e) {
      // const self = this
      this.recordVM.next(function () {});
    },
    toSearch: function toSearch(e) {
      var times = parseInt(e.value);
      console.log(times, '--------------------------');
      this.$refs.searchBar.autoBlur();
      console.log(times, '------------autoBlur--------------');
      // 重新
      this.recordVM.init(times, function () {});
    }
  }
};
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/node_modules/weex-ui/packages/wxc-searchbar/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/node_modules/weex-ui/packages/wxc-tab-page/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
var _bindEnv = __webpack_require__(123);

var _bindEnv2 = _interopRequireDefault(_bindEnv);

var _indexWeex = __webpack_require__(48);
...
recordType.names = ['1小时时间到记录', '温度变化', '湿度变化', '温度目标变化', '湿度目标变化', '程序启动', '运行', '停止', '状态变化', '来电', '停电'];
...
Record.prototype.shedName = function () {
  return _Curve.Shed.names[this.shed];
};

Record.prototype.tStatusName = function () {
  return _Curve.Phase.names[this.tStatus];
};
...
Record.prototype.getRecodDate = function () {
  var year = this.year > 9 ? '20' + this.year : '200' + this.year;
...
RecordVM.prototype.init = function (bakeTimes) {
  ...
  function recursion() {
    ...
    self.request(self.page, function (state, msg, record) {
      if (self.totalPage === 0) {
        return;
      }
...
RecordVM.prototype.request = function (num, callback) {
  ...
  _Request.request.getRecord(param, function (state, msg, data) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "wxcSearchbarInputOnBlur": _vm.toSearch
    }
  }), _c('text', {
    staticClass: ["title", "maxFont"]
  }, [_vm._v("第" + _vm._s(_vm.baketimeNames[_vm.recordVM.bakeTimes]) + "烤 (记录总数:" + _vm._s(_vm.recordVM.totalPage) + ")")]), _c('list', {
    ref: "record_list"
  }, [_vm._l((_vm.recordVM.currents), function(item, i) {
    return _c('cell', {
      key: i,
      staticClass: ["cell0"],
      appendAsTree: true,
    ...
    }, [_vm._v(_vm._s(item.getRecodDate()))]), _c('div', {
      staticClass: ["cell_base"]
    }, [_c('text', {
      staticClass: ["minFont"]
    }, [_vm._v("编号：" + _vm._s(item.record))]), _c('text', {
      staticClass: ["minFont"]
    }, [_vm._v(_vm._s(item.shedName()))]), _c('text', {
      staticClass: ["minFont"]
    }, [_vm._v(_vm._s(item.tStatusName()))])]), _c('div', {
      staticClass: ["cell_base"]
    }, [_c('text', {
      staticClass: ["minFont"]
    }, [_vm._v("干球温度：" + _vm._s(item.dry) + "℃")]), _c('text', {
      staticClass: ["minFont"]
    }, [_vm._v("目标：" + _vm._s(item.dryAim) + "℃")])]), _c('div', {
      staticClass: ["cell_base"]
    }, [_c('text', {
      staticClass: ["minFont"]
    }, [_vm._v("湿球温度：" + _vm._s(item.wet) + "℃")]), _c('text', {
      staticClass: ["minFont"]
    }, [_vm._v("目标：" + _vm._s(item.wetAim) + "℃")])]), _c('div', {
      staticClass: ["cell_base"]
    }, [_c('text', {
      staticClass: ["minFont"]
    }, [_vm._v("记录类型")]), _c('text', {
      ...
      staticClass: ["minFont"]
    }, [_vm._v("总时间:" + _vm._s(item.total) + "h")])]), _c('div', {
      staticClass: ["cell_base"]
    }, [_c('text', {
      staticClass: ["minFont"]
    }, [_vm._v(_vm._s(item.eventName()))])])])])
  }), (_vm.recordVM.loadmore) ? _c('cell', {
    staticStyle: {
      paddingLeft: "20px",
      paddingRight: "20px"
    },
