...
var _AddDeviceViewController = __webpack_require__(50);

var _AddDeviceViewController2 = _interopRequireDefault(_AddDeviceViewController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_AddDeviceViewController2.default.el = '#root';
new Vue(_AddDeviceViewController2.default);
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/src/AddDeviceViewController.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5f259c6f"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var scanCode = weex.requireModule('ScanCode');
var modal = weex.requireModule('modal');
var navigator = weex.requireModule('navigator');

exports.default = {
  name: 'AddDeviceViewController',
  components: { NavBar: _NavBar2.default, WxcMask: _wxcMask2.default },
  data: function data() {
    return {
      env: weex.config.env,
      mid: {}
  ...
  destroyed: function destroyed() {
    _Request.request.interrupt(_Order.SubOrder.addDevice, _Order.RW.read);
  },
  ...
  methods: {
    ...
    toMakeSure: function toMakeSure() {
      ...
      _Request.request.addDevice(id, remark, function (state, msg, data) {
    ...
    midInput: function midInput(e) {
      _vue2.default.set(this.mid, 'id', e.value);
    },
    remarkInput: function remarkInput(e) {
      _vue2.default.set(this.mid, 'remark', e.value);
    },
    clickScan: function clickScan() {
      var self = this;
      scanCode.scan(function (e) {
        _vue2.default.set(self.mid, 'id', e);
      });
    }
  }
};
