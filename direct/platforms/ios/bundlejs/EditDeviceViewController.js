...
var _EditDeviceViewController = __webpack_require__(83);

var _EditDeviceViewController2 = _interopRequireDefault(_EditDeviceViewController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_EditDeviceViewController2.default.el = '#root';
new Vue(_EditDeviceViewController2.default);
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/src/EditDeviceViewController.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-314427ba"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  components: { UIButton: _UIButton2.default, NavBar: _NavBar2.default },
  data: function data() {
    return {
      mid: {}
    };
  ...
  created: function created() {
    var self = this;
    userInfoModule.getParam(function (e) {
      self.mid = e.data;
    });
  },
  destroyed: function destroyed() {
    _Request.request.interrupt(_Order.SubOrder.editDevice, _Order.RW.read);
  },
  ...
  methods: {
    ...
    toMakeSure: function toMakeSure() {
      ...
      console.log(JSON.stringify(param), '--------------------');
      _Request.request.editDevice(param, function (state, msg, data) {
    ...
    bind: function bind(e) {
      ...
      var id = parseInt(Math.random() * (255 - 100 + 1) + 100, 10);
      // let id = (Math.random() * (1000 - 100)) * 100
      var param = { id: id, mid: this.mid.mid, isbind: true };

      _Request.request.bind(param, function (state, msg, data) {
        if (state === _Request.State.success) {
          _Request.request.bindService(param, function (state0, msg0, data0) {
    ...
    unbind: function unbind(e) {
      ...
      var id = parseInt(Math.random() * (255 - 100 + 1) + 100, 10);
      var param = { id: id, mid: this.mid.mid, isbind: false };
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('nav-bar', {
  ...
  }, [_vm._v(_vm._s(_vm.mid.mid))])]), _c('div', {
    staticStyle: {
      flexDirection: "row"
    }
  }, [_c('text', {
    ...
    attrs: {
      "type": "text",
      "placeholder": "请输入备注",
      "value": _vm.mid.remark
    },
    on: {
      "input": _vm.remarkInput
    }
  })]), (!_vm.mid.bind) ? _c('u-i-button', {
    staticClass: ["button"],
    attrs: {
      "title": "绑定"
    },
  ...
  }) : _vm._e(), (_vm.mid.bind) ? _c('u-i-button', {
    staticClass: ["button"],
    attrs: {
      "bgColor": "red",
      "title": "解除绑定"
