...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/node_modules/weex-ui/packages/wxc-mask/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/node_modules/weex-ui/packages/wxc-overlay/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
exports.CurveNum = CurveNum;
exports.Curve = Curve;
var Coding = exports.Coding = { self: 0, down: 1, middle: 2, up: 3 };
Coding.names = ['自设', '下部叶', '中部叶', '上部叶'];

var Phase = exports.Phase = { up: 0, steady: 1 };
Phase.names = ['升温', '恒温'];

var Shed = exports.Shed = { down: 0, up: 1 };
Shed.names = ['下棚', '上棚'];
Shed.reverseNames = ['上棚', '下棚'];

function CurveNum(value) {
  var isPhase = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
var curveNumEnum = exports.curveNumEnum = ['一阶段', '二阶段', '三阶段', '四阶段', '五阶段', '六阶段', '七阶段', '八阶段', '九阶段', '十阶段'];

function Curve(up, wet, dry, steady, curveNum) {
  this.up = up;
  this.wet = wet;
  this.dry = dry;
  this.steady = steady;
...
var _HomeViewController = __webpack_require__(88);

var _HomeViewController2 = _interopRequireDefault(_HomeViewController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_HomeViewController2.default.el = '#root';
new Vue(_HomeViewController2.default);
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/src/HomeViewController.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-416352ce"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _wxcPopup = __webpack_require__(91);
...
var _HomeVM = __webpack_require__(96);

var _Curve = __webpack_require__(29);
...
exports.default = {
  ...
  components: {
    ...
    FlexWap: _FlexWap2.default,
    UILine: _UILine2.default,
    NavBar: _NavBar2.default,
    Radio: _Radio2.default,
    SegmentControl: _SegmentControl2.default,
  ...
  methods: {
    onViewAppear: function onViewAppear() {
      ...
      userInfoModule.getParam(function (mid) {
        self.homeVM.mid = mid;
        self.homeVM.created(function (state, msg) {
          if (self.homeVM.type[1] === 'S') {
            navigator.setNavBarRightItem({ title: '燃烧机', titleColor: '#000000' }, function () {});
            self.rightTitle = '燃烧机';
          } else {
            navigator.setNavBarRightItem({ title: '', titleColor: '#000000' }, function () {});
            self.rightTitle = '';
          }
        });
      });
    ...
    onViewDisappear: function onViewDisappear() {
      _Request.request.interrupt(_Order.SubOrder.status, _Order.RW.read);
      _Request.request.interrupt(_Order.SubOrder.realTime, _Order.RW.read);
      _Request.request.interrupt(_Order.SubOrder.time, _Order.RW.read);
      _Request.request.interrupt(_Order.SubOrder.curves, _Order.RW.read);
    },
    ...
    doDetail: function doDetail() {
      ...
      if (this.isShowDetail) {
        this.homeVM.getCurves(function (state, msg) {
    ...
    /* TODO 切换曲线段号 */
    doCurveNum: function doCurveNum(item, phase) {
      var _this = this;

      if (phase !== undefined) {
        item.num.phaseValue = phase;
        item.num.reversePhase = _Curve.Phase.names[phase];
      } else {
        item.num.phaseValue = item.num.reverseValue;
      }
      var message = '是否切换到' + item.num.title + item.num.reversePhase;
      modal.confirm({
        message: message,
        okTitle: '确定',
        cancelTitle: '取消'
        ...
        if (result === '确定') {
          ...
          _this.homeVM.setCurveNum(item, function (state, msg) {});
        }
      });
    },

    // TODO 切换曲线模式
    doSegment: function doSegment(e) {
      var _this2 = this;
      ...
      var coding = e.data;
      var name = _Curve.Coding.names[coding];
      ...
      modal.confirm({
        ...
        if (result === '否') {
          ...
          e.callback(false);
          _this2.homeVM.curveCoding(coding);
        }
      });
    },

    // TODO 干球温度
    toChangeDry: function toChangeDry(item) {
      var _this3 = this;
      ...
      modal.prompt({
        ...
        if (res.result === '否') {} else {
          var curve = JSON.parse(JSON.stringify(item));
          curve.dry = res.data;
          _this3.homeVM.setCurve(curve);
        }
      });
    },

    /// TODO 湿球温度
    toChangeWet: function toChangeWet(item) {
      var _this4 = this;
      ...
      modal.prompt({
        ...
        if (res.result === '否') {} else {
          ...
          _this4.homeVM.setCurve(curve);
        }
      });
    },

    /// TODO 升温时间
    toChangeUp: function toChangeUp(item) {
      var _this5 = this;
      ...
      modal.prompt({
        ...
        if (res.result === '否') {} else {
          var curve = JSON.parse(JSON.stringify(item));
          curve.up = res.data;
          _this5.homeVM.setCurve(curve);
        }
      });
    },

    /// TODO 恒温时间
    toChangeSteady: function toChangeSteady(item) {
      var _this6 = this;
      ...
      modal.prompt({
        ...
        if (res.result === '否') {} else {
          ...
          _this6.homeVM.setCurve(curve);
        }
      });
    },

    /// TODO 上下棚
    toHiddenShed: function toHiddenShed(e) {
      this.isShowShed = false;
      this.changeShed(0);
    },
    toShed: function toShed(e) {
      var _this7 = this;
      ...
      var shed = e.index === 0 ? _Curve.Shed.up : _Curve.Shed.down;
      this.targetTitle = e.title;
      this.target = e.title;
      this.isShowShed = true;
      this.changeShed = function (index) {
        _this7.isShowShed = false;

        if (index === 0) {
          e.callback(false);
        } else if (index === 1) {
          e.callback(false);
          _this7.homeVM.setShed(shed);
        }
      };
    },
    doShed: function doShed() {
      this.changeShed(1);
    },
    toRoast: function toRoast() {
      var _this8 = this;
      ...
      var times = this.homeVM.bakeTimes;
      picker.pick({
        title: '修改烤次',
        confirmTitle: '确认',
        cancelTitle: '取消',
        ...
        if (event.result === 'success') {
          var bakeTimes = event.data;
          _this8.homeVM.setTime({ bakeTimes: bakeTimes }, function () {});
        }
      });
    },
    ...
    toTime: function toTime() {
      ...
      var aDate = this.homeVM.hour + ':' + this.homeVM.minute;
      picker.pickTime({
        value: aDate
      }, function (event) {
        if (event.result === 'success') {
          ...
          _this9.homeVM.setTime({ hour: hour, minute: minute }, function () {});
        }
      });
    },
    toDate: function toDate() {
      ...
      var aDate = '20' + (this.homeVM.year > 9 ? this.homeVM.year : '0' + this.homeVM.year) + '-' + this.homeVM.month + '-' + this.homeVM.day;
      console.log(aDate, '--------------------------------------');
      picker.pickDate({
        value: aDate,
        min: '2000-01-01',
        ...
        if (event.result === 'success') {
          var arr = event.data.split('-');
          var year = parseInt(arr[0]) - 2000;
          var month = parseInt(arr[1]);
          var day = parseInt(arr[2]);
          _this10.homeVM.setTime({ year: year, month: month, day: day }, function () {});
        }
      });
    },

    /// TODO 分机运行/停止控制
    toRun: function toRun() {
      var _this11 = this;
      ...
      var okTitle = this.homeVM.run ? '停止' : '开启';
      var cancelTitle = '取消';
      var message = this.homeVM.run ? '是否停止运行?' : '是否开启设备?';
      modal.confirm({ message: message, okTitle: okTitle, cancelTitle: cancelTitle }, function (e) {
        if (e === okTitle) {
          _this11.homeVM.run = _this11.homeVM.run === 0 ? 1 : 0;
          _this11.homeVM.setRun(function () {});
        }
      });
    },
    ...
    toRecord: function toRecord() {
      ...
      var url = weex.config.bundleUrl + 'RecordViewController.js';
      var param = { mid: JSON.parse(JSON.stringify(this.homeVM.mid)) };
    ...
    toSet: function toSet() {
      var url = weex.config.bundleUrl + 'SetHomeViewController.js';
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    toRight: function toRight() {
      console.log('toRight----------');
      var url = weex.config.bundleUrl + 'BurnerViewController.js';
      var param = JSON.parse(JSON.stringify(this.homeVM.mid));
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/node_modules/weex-ui/packages/wxc-popup/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
function HomeVM() {
  ...
  this.sheds = [{ title: _Curve.Shed.names[_Curve.Shed.up], value: _Curve.Shed.up, checked: false }, { title: _Curve.Shed.names[_Curve.Shed.down], value: _Curve.Shed.down, checked: false }];
  this.codings = _Curve.Coding.names;
...
HomeVM.prototype.created = function (callback) {
  ...
  this.__status(function (state, msg) {
    _this.__time(function (state, msg) {
      _this.__realtime(function (state, msg) {
        callback(state, msg);
        _this.handler = true;
      });
    });
...
HomeVM.prototype.getCurves = function (callback) {
  ...
  var param = JSON.parse(JSON.stringify(this.mid));
  param.coding = this.coding;

  _Request.request.curves(_Order.RW.read, param, function (state, msg, data) {
    if (state === _Request.State.success) {
      _this2.coding = data.coding;

      for (var i = 0, len = data.curves.length; i < len; i++) {
        var curve = data.curves[i];
        var curveNum = new _Curve.CurveNum(i);
        _this2.curves[i] = new _Curve.Curve(curve.up, curve.wet.toFixed(1), curve.dry.toFixed(0), curve.steady, curveNum);
      }
      _this2.__dealCurves();
      _this2.__realtime();
    }
...
HomeVM.prototype.setCurve = function (curve, callback) {
  ...
  var curveNum = _Curve.CurveNum.num(curve.num);
  param.coding = this.coding;
  param.curveNum = curveNum;
  param.curve = curve;

  _Request.request.curve(_Order.RW.write, param, function (state, msg, data) {
    if (state === _Request.State.success && data.coding === _this3.coding) {
      if (_this3.curves.length !== 0) {
        var _curve = _this3.curves[curve.num.value];
        ...
        _Vue2.default.set(_this3.curves, curve.num.value, _curve);
        _this3.__dealCurves();
      }
    }
    _this3.__realtime();
...
HomeVM.prototype.setCurveNum = function (curveNum, callback) {
  ...
  param.curveNum = _Curve.CurveNum.num(curveNum.num);
  _Request.request.curveNum(param, function (state, msg, data) {
    callback(state, msg);
    _this4.__realtime();
  });
};
...
HomeVM.prototype.curveCoding = function (coding) {
  ...
  param.coding = coding;
  _Request.request.curveCoding(param, function (state, msg, data) {
    _this5.coding = data.coding;
    _this5.__realtime();
  });
};
/* TODO 设置分机上/下棚 */
HomeVM.prototype.setShed = function (shed, callback) {
  ...
  _Request.request.shed(param, function (state, msg, data) {
    if (state === _Request.State.success) {
      _this6.shed = data.shed;
      // this.__dealShed()
    }
    if (callback !== undefined) {
      callback(state, msg);
...
HomeVM.prototype.setRun = function (callback) {
  ...
  param.run = this.run;
  _Request.request.run(param, function (state, msg, data) {
    if (state === _Request.State.success) {
      _this7.run = data.run;
    }
    callback(state, msg);
...
HomeVM.prototype.__status = function (callback) {
  var param = JSON.parse(JSON.stringify(this.mid));
  var self = this;
  _Request.request.status(param, function (state, msg, data) {
    if (state !== _Request.State.success) {
      callback(state, msg);
      return;
    }
...
HomeVM.prototype.__realtime = function (callback) {
  ...
  var param = JSON.parse(JSON.stringify(this.mid));
  _Request.request.realTime(param, function (state, msg, data) {
    if (state !== _Request.State.success) {
      if (callback !== undefined) {
        callback(state, msg);
      }
    ...
    _this8.coding = data.coding;
    _this8.run = data.run;
    _this8.shed = data.shed;
    _this8.subAlarm = data.subAlarm;
    _this8.dryT = data.dryT.toFixed(2);
    _this8.wetT = data.wetT.toFixed(2);
    _this8.time = data.time;
    _this8.timeTotal = data.timeTotal;
    _this8.dryAim = data.dryAim.toFixed(0);
    _this8.wetAim = data.wetAim.toFixed(1);
    _this8.voltage = data.voltage;
    _this8.isAlarm = data.isAlarm;
    _this8.voltageStatus = data.voltageStatus;
    _this8.isFanOn = data.isFanOn;
    _this8.fan = data.fan;
    _this8.warm = data.warm;
    _this8.intakeOn = data.intakeOn;
    _this8.alarmStatus = data.alarmStatus;
    _this8.dryTHelp = data.dryTHelp.toFixed(2);
    _this8.wetTHelp = data.wetTHelp.toFixed(2);

    var currentCurve = data.currentCurve;
    var up = currentCurve.up;
    var wet = currentCurve.wet.toFixed(1);
    var dry = currentCurve.dry.toFixed(0);
    var steady = currentCurve.steady;
    var curveNum = new _Curve.CurveNum(data.curveNum, true);

    _this8.currentCurve = new _Curve.Curve(up, wet, dry, steady, curveNum);
    _this8.__dealCurves();
    _this8.__dealShed();

    if (_this8.mid.bind !== data.isbind) {
      var param0 = JSON.parse(JSON.stringify(_this8.mid));
      param0.isbind = data.isbind;

      console.log(JSON.stringify(param0));
      _Request.request.bindService(param0, function (state0, msg0, data0) {
        if (state0 === _Request.State.success) {
          _this8.mid.bind = data.isbind;
          console.log(JSON.stringify(_this8.mid));
        }
        _this8.__realtime();
      });
    }
...
HomeVM.prototype.__time = function (callback) {
  ...
  var param = JSON.parse(JSON.stringify(this.mid));
  _Request.request.time(_Order.RW.read, param, function (state, msg, data) {
    if (state !== _Request.State.success) {
      callback(state, msg);
      return;
    }
    _this9.bakeTimes = data.bakeTimes;
    _this9.year = data.year;
    _this9.month = data.month;
    _this9.day = data.day;
    _this9.hour = data.hour;
    _this9.minute = data.minute;
    callback(state, msg);
  });
};
...
HomeVM.prototype.setTime = function (param, callback) {
  ...
  var param0 = JSON.parse(JSON.stringify(this.mid));
  if (!param0.bind) {
    this.modal.toast({
      message: '请先在设备编辑页，绑定该设备！',
      duration: 1.0
  ...
  var assign = Object.assign(param, this.mid);
  _Request.request.time(_Order.RW.write, assign, function (state, msg, data) {
    if (state !== _Request.State.success) {
      callback(state, msg);
      return;
    }
    _this10.bakeTimes = data.bakeTimes;
    _this10.year = data.year;
    _this10.month = data.month;
    _this10.day = data.day;
    _this10.hour = data.hour;
    _this10.minute = data.minute;
    callback(state, msg);
    _this10.__realtime();
  });
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "title": "实时监控",
      "left": "返回",
      "right": _vm.rightTitle
    },
    on: {
      "rightButtonClicked": _vm.toRight
    }
  }), _c('list', [_c('cell', {
    appendAsTree: true,
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.homeVM.mid.remark))])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["layout0"]
  }, [(_vm.env.platform === 'android') ? _c('radio', {
    staticClass: ["radio"],
    staticStyle: {
      height: "120px"
    },
    attrs: {
      "list": _vm.homeVM.sheds
    },
    on: {
      "radioListChecked": _vm.toShed
    }
  }) : _vm._e(), (_vm.env.platform !== 'android') ? _c('radio', {
    staticClass: ["radio"],
    attrs: {
      "list": _vm.homeVM.sheds
    },
    ...
    staticClass: ["tName", "minFont"]
  }, [_vm._v("干球温度℃")]), _c('text', {
    staticClass: ["tValue0", "maxFont"]
  }, [_vm._v(_vm._s(_vm.homeVM.dryT))])]), _c('div', {
    staticClass: ["temperature"]
  }, [_c('text', {
    staticClass: ["tName", "minFont"]
  }, [_vm._v("湿球温度℃")]), _c('text', {
    staticClass: ["tValue1", "maxFont"]
  }, [_vm._v(_vm._s(_vm.homeVM.wetT))])])], 1), _c('div', {
    staticClass: ["layout1"]
  }, [_c('div', {
    class: [_vm.homeVM.run ? 'rundiv' : 'rundiv0']
  }, [_c('text', {
    class: [_vm.homeVM.run ? 'runText' : 'runText0']
  }, [_vm._v(_vm._s(_vm.homeVM.run ? '运行' : '停止'))])]), _c('div', {
    staticClass: ["targetdiv"]
  }, [_c('text', {
    staticClass: ["targetText", "minFont"]
  }, [_vm._v("目标：" + _vm._s(_vm.homeVM.dryAim))])]), _c('div', {
    staticClass: ["targetdiv"]
  }, [_c('text', {
    staticClass: ["targetText", "minFont"]
  }, [_vm._v("目标：" + _vm._s(_vm.homeVM.wetAim))])])])])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["tName", "minFont"]
  }, [_vm._v("阶段时间：" + _vm._s(_vm.homeVM.time))]), _c('text', {
    staticClass: ["tName", "minFont"]
  }, [_vm._v("总时间: " + _vm._s(_vm.homeVM.timeTotal))])])]), _c('cell', {
    staticStyle: {
      flexDirection: "row"
    },
    appendAsTree: true,
    ...
    staticClass: ["minFont"]
  }, [_vm._v("报警状态: " + _vm._s(_vm.homeVM.hasBug()))]), _c('flex-wap', {
    attrs: {
      "list": _vm.homeVM.alarmStatus,
      "width": 510
    }
  })], 1)]), _c('cell', {
    appendAsTree: true,
    ...
    attrs: {
      "activeIndex": _vm.homeVM.coding,
      "items": _vm.homeVM.codings
    },
    on: {
      "segmentClicked": _vm.doSegment
    }
  })], 1)]), _c('cell', {
    appendAsTree: true,
    attrs: {
  ...
  }, [(!_vm.isShowDetail && _vm.homeVM.currentCurve.hasOwnProperty('num')) ? _c('div', {
    staticClass: ["layout5_1"]
  }, [_c('div', [_c('div', {
    staticClass: ["cuverTitle"]
  }, [_c('text', {
    staticClass: ["cuverTitleText", "minFont"]
  }, [_vm._v(_vm._s(_vm.homeVM.getCurTitle()))]), _c('text', {
    staticClass: ["cuverTitleText0", "minFont"]
  }, [_vm._v("(当前" + _vm._s(_vm.homeVM.getCurPhase()) + ")")])]), _c('div', {
    staticClass: ["cuverContent"]
  }, [_c('div', {
    staticClass: ["cuverContent0"]
  }, [_c('text', {
    staticClass: ["cuverContentText", "minFont"],
    on: {
      "click": function($event) {
        _vm.toChangeDry(_vm.homeVM.currentCurve)
      }
    }
  }, [_vm._v("干球温度：" + _vm._s(_vm.homeVM.currentCurve.dry) + "℃")]), _c('text', {
    staticClass: ["cuverContentText", "minFont"],
    on: {
      "click": function($event) {
        _vm.toChangeUp(_vm.homeVM.currentCurve)
      }
    }
  }, [_vm._v("升温时间：" + _vm._s(_vm.homeVM.currentCurve.up) + "h")])]), _c('div', {
    staticClass: ["cuverContent1"]
  }, [_c('text', {
    staticClass: ["cuverContentText0", "minFont"],
    on: {
      "click": function($event) {
        _vm.toChangeWet(_vm.homeVM.currentCurve)
      }
    }
  }, [_vm._v("湿球温度：" + _vm._s(_vm.homeVM.currentCurve.wet) + "℃")]), _c('text', {
    staticClass: ["cuverContentText0", "minFont"],
    on: {
      "click": function($event) {
        _vm.toChangeSteady(_vm.homeVM.currentCurve)
      }
    }
  }, [_vm._v("恒温时间：" + _vm._s(_vm.homeVM.currentCurve.steady) + "h")])])])]), _c('u-i-line'), _c('div', {
    staticClass: ["cellButton"]
  }, [_c('text', {
    staticClass: ["cellButtonTxt_left"],
    on: {
      "click": _vm.doDetail
    }
  }, [_vm._v("更多……")]), (_vm.homeVM.currentCurve.num.value !== 0) ? _c('text', {
    staticClass: ["cellButtonTxt_right"],
    on: {
      "click": function($event) {
        _vm.doCurveNum(_vm.homeVM.currentCurve)
      }
    }
  }, [_vm._v("切换到" + _vm._s(_vm.homeVM.currentCurve.num.reversePhase))]) : _vm._e()])], 1) : _vm._e(), (_vm.isShowDetail && _vm.homeVM.currentCurve.hasOwnProperty('num')) ? _c('div', {
    staticClass: ["layout5_2"]
  }, [_c('div', [_c('div', {
    staticClass: ["cuverTitle"]
  }, [_c('text', {
    staticClass: ["cuverTitleText_1", "minFont"]
  }, [_vm._v(_vm._s(_vm.homeVM.getCurTitle()))]), _c('text', {
    staticClass: ["cuverTitleText0_1", "minFont"]
  }, [_vm._v("(当前" + _vm._s(_vm.homeVM.getCurPhase()) + ")")])]), _c('div', {
    staticClass: ["cuverContent"]
  }, [_c('div', {
    staticClass: ["cuverContent0"]
  }, [_c('text', {
    staticClass: ["cuverContentText_1", "minFont"],
    on: {
      "click": function($event) {
        _vm.toChangeDry(_vm.homeVM.currentCurve)
      }
    ...
    staticClass: ["cuverContentText0_1", "minFont"],
    on: {
      "click": function($event) {
        _vm.toChangeWet(_vm.homeVM.currentCurve)
      }
    ...
    staticClass: ["cellButtonTxt_left_selected"],
    on: {
      "click": _vm.doDetail
    }
  }, [_vm._v("收起")]), (_vm.homeVM.currentCurve.num.value !== 0) ? _c('text', {
    staticClass: ["cellButtonTxt_right_selected"],
    on: {
      "click": function($event) {
        _vm.doCurveNum(_vm.homeVM.currentCurve)
      }
    }
  }, [_vm._v("切换到" + _vm._s(_vm.homeVM.currentCurve.num.reversePhase))]) : _vm._e()])], 1) : _vm._e()]), _vm._l((_vm.homeVM.displayCurves), function(item, i) {
    return (_vm.isShowDetail) ? _c('cell', {
      key: i,
      staticStyle: {
        padding: "10px"
      },
      ...
      staticClass: ["cuverTitleText1", "minFont"]
    }, [_vm._v(_vm._s(item.num.title))]), _c('div', {
      staticClass: ["cuverContent"]
    }, [_c('div', {
      staticClass: ["cuverContent0"]
    }, [_c('text', {
      ...
      on: {
        "click": function($event) {
          _vm.toChangeDry(item)
        }
      }
    }, [_vm._v("干球温度：" + _vm._s(item.dry) + "℃")]), _c('text', {
      staticClass: ["cuverContentText", "minFont"],
      on: {
        "click": function($event) {
          _vm.toChangeUp(item)
    ...
    }, [_vm._v("升温时间：" + _vm._s(item.up) + "h")])]), _c('div', {
      staticClass: ["cuverContent1"]
    }, [_c('text', {
      staticClass: ["cuverContentText0", "minFont"],
      on: {
        "click": function($event) {
          _vm.toChangeWet(item)
        }
      }
    }, [_vm._v("湿球温度：" + _vm._s(item.wet) + "℃")]), _c('text', {
      staticClass: ["cuverContentText0", "minFont"],
      on: {
        "click": function($event) {
          _vm.toChangeSteady(item)
        }
      }
    }, [_vm._v("恒温时间：" + _vm._s(item.steady) + "h")])])]), _c('u-i-line'), _c('div', {
      staticClass: ["cellButton"]
    }, [(item.num.value !== 0) ? _c('text', {
      staticClass: ["cellButtonTxt_left"],
      on: {
        "click": function($event) {
          _vm.doCurveNum(item, _vm.Phase.up)
        }
      }
    }, [_vm._v("切换到升温")]) : _vm._e(), _c('text', {
      staticClass: ["cellButtonTxt_right"],
      on: {
        "click": function($event) {
          _vm.doCurveNum(item, _vm.Phase.steady)
        }
      }
    }, [_vm._v("切换到恒温")])])], 1)]) : _vm._e()
  }), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    ...
    class: [_vm.homeVM.warm ? 'statusOn' : 'statusOff']
  }, [_vm._v("助燃")]), _c('text', {
    class: [_vm.homeVM.intakeOn ? 'statusOn' : 'statusOff']
  }, [_vm._v("排湿")]), _c('text', {
    staticClass: ["minFont"]
  }, [_vm._v("电压 " + _vm._s(_vm.homeVM.voltage) + " V")]), _c('text', {
    class: [_vm.homeVM.isFanOn ? 'statusOn' : 'statusOff']
  }, [_vm._v("循环机风速 " + _vm._s(_vm.homeVM.fan))])])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  ...
  }, [_vm._v("第" + _vm._s(_vm.homeVM.bakeTimes) + "烤")]), _c('text', {
    staticClass: ["minFont"],
    on: {
      "click": _vm.toDate
    }
  }, [_vm._v("20" + _vm._s(_vm.homeVM.year > 9 ? _vm.homeVM.year : ('0' + _vm.homeVM.year)) + "年" + _vm._s(_vm.homeVM.month) + "月" + _vm._s(_vm.homeVM.day) + "日")]), _c('text', {
    staticClass: ["minFont"],
    on: {
      "click": _vm.toTime
    }
  }, [_vm._v(_vm._s(_vm.homeVM.hour) + ":" + _vm._s(_vm.homeVM.minute))])])])], 2), _c('div', {
    staticClass: ["layout8"]
  }, [_c('u-i-button', {
    staticClass: ["bottomBtn"],
    attrs: {
      "title": _vm.homeVM.run ? '停止' : '运行',
      "bgColor": "white",
      "color": "black",
      "borderRadius": 0
    },
    ...
    on: {
      "wxcMaskSetHidden": _vm.toHiddenShed
    }
  }, [_c('div', {
    staticClass: ["alert"]
  }, [_c('text', {
    staticClass: ["middleFont", "alertTitle"]
  }, [_vm._v(_vm._s(_vm.targetTitle))]), _c('div', {
    staticClass: ["layout"]
  }, [_c('div', {
    staticClass: ["layout0"]
  }, [_c('div', {
    ...
    staticClass: ["tValue0", "maxFont"]
  }, [_vm._v(_vm._s(_vm.homeVM.dryTHelp))])]), _c('div', {
    staticClass: ["temperature"]
  }, [_c('text', {
    staticClass: ["tName", "minFont"]
  }, [_vm._v("湿球温度℃")]), _c('text', {
    staticClass: ["tValue1", "maxFont"]
  }, [_vm._v(_vm._s(_vm.homeVM.wetTHelp))])])])]), _c('div', {
    staticClass: ["alertBtttonDiv"]
  }, [_c('text', {
    staticClass: ["alertBttton0", "minFont"],
    on: {
      "click": _vm.toHiddenShed
    }
  }, [_vm._v("取消")]), _c('text', {
    staticClass: ["alertBttton2", "minFont"],
    on: {
      "click": _vm.doShed
    }
  }, [_vm._v("切换到" + _vm._s(_vm.target))])])])])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
