...
var _MyViewController = __webpack_require__(105);

var _MyViewController2 = _interopRequireDefault(_MyViewController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_MyViewController2.default.el = '#root';
new Vue(_MyViewController2.default);
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/src/MyViewController.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-78ec8a66"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  created: function created() {
    var self = this;
    _Request.request.userInfo(function (state, msg, data) {
  ...
  destroyed: function destroyed() {
    ...
    _Request.request.interrupt(_Order.SubOrder.userInfo, _Order.RW.read);
  },
  ...
  methods: {
    ...
    pushModifyPwd: function pushModifyPwd() {
    ...
    pushWIFI: function pushWIFI() {
      var url = weex.config.bundleUrl + 'WIFIViewController.js';
      navigator.push({
        url: url
      });
    },
    logout: function logout() {
      _Request.request.logout(function (state, msg, data) {
        if (state === _Request.State.success) {
          navigator.pop({
            root: true
          });
