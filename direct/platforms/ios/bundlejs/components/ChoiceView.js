...
var _ChoiceView = __webpack_require__(67);

var _ChoiceView2 = _interopRequireDefault(_ChoiceView);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_ChoiceView2.default.el = '#root';
new Vue(_ChoiceView2.default);
...
__vue_options__.__file = "/Users/zzzl/Documents/APP项目/direct/src/components/ChoiceView.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c4f1e9d4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    wxcOverlayBodyClicked: function wxcOverlayBodyClicked() {
      this.$emit('doClick', { show: this.show });
    }
  }
}; //
//
